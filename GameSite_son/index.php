...
<?php
  ...
  mysqli_select_db($conn, "osmancetin");
	...
	$limit="1";
	 $sql1000 = "SELECT name FROM tbGame WHERE player='123' ";  // herhangi bir oyunu vt den çekmeye çalışıyorum
	 $result = $conn->query($sql1000);
	 $sresult = (array)$result;
			...
			<div class="home-slider">
				<ul class="slides">
					...
					<li data-bg-image="dummy/slide-2.jpg">
						<div class="container">
							<div class="slide-content">
								<h2 class="slide-title">Need For Speed Rival</h2>
								<small class="slide-subtitle">$190.00</small>
							...
							<div class="product-list">
								<div class="product">
									<div class="inner-product">
										...
										echo "$sresult";  // Burada yazrıması gerekiyor fakat ekrana basamadım.
