	...
	<body class="slider-collapse">
      ...
      <main class="main-content">
          <div class="container">
            ...
            <form action="completed.php" target="" method="GET">
                ...
                <div class="col-md-3">
                  <table id="category" border=0>
                    ...
                    <tr>
                      <td><input type="button" value="Add Row" onclick="addRow('platform')" /></td>
                      <td><input type="button" value="Delete Row" onclick="deleteRow('platform')" /></td>
                    </tr>
